...
router.route('/')
  .post(protect, authorize('admin', 'manager'), validateProduct, upload.array('images', 5), createProduct)
...
router.route('/:id')
  ...
  .put(protect, authorize('admin', 'manager'), validateProduct, upload.array('images', 5), updateProduct)
